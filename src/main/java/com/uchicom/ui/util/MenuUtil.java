...
public class MenuUtil {
	...
	public static <T extends Component> Action createAction(UIStore<T> uiStore, Properties resource, Map<String, Action> actionMap, String actionKey)
		...
		if (resource.containsKey(actionKey)) {
			...
			if (action == null) {
				action = (Action) Class.forName(className).getConstructor(UIStore.class).newInstance(uiStore);
